...
这时候你可以尝试着去做一些开源贡献了，可以从最简单的找错别字开始，注释里面的错别字，语法错误，机翻，你都可以提出你自己的pr。然后可以在仓库的issue里，看看别人提出的问题或者bug或者建议，你就可以尝试着帮作者解决这些问题。错别字和这些解决issue的贡献，一般仓库的作者都是很乐意接受的，一般都会给你通过。等你牛逼了你可以在这里面留下属于你的代码。这就是开源贡献。

开源贡献其实地位类似于做项目，其实甚至比做项目还牛逼，找工作或者考研是完全可以作为很大的加分项的，而且不同于做项目，这样显得你对编程，开源很有理解，而且体现出你有一种乐于奉献的精神。
（其实有些公司明确指出优先录用有做过开源贡献的人，大家可以留意一下)

一件很有意思的事情
有些仓库是显示如果你为这个仓库做出了贡献，那么你的头像将会出现在这个仓库的这个位置
![image-20240331195247507](https://starain-1252568110.cos.ap-beijing.myqcloud.com/blog/image-20240331195247507.png)

只要这个仓库存在，那么大家就一直记得你是贡献者！
